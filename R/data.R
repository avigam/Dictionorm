...
#' 
#' @references Nielsen, F.Å. (2011). \href{https://arxiv.org/abs/1103.2903}{A new ANEW: Evaluation of a Word List for Sentiment Analysis in Microblogs.} In *Proceedings of the ESWC2011 Workshop on 'Making Sense of Microposts': Big Things Come in Small Packages*, 93–98.
"AFINN"


#' Age of Aquisition Norms for English Words (AoA)
#'
...
#' 
#' @references Brysbaert, M., Biemiller, A. (2017). \href{https://link.springer.com/article/10.3758/s13428-016-0811-4}{Test-based age-of-acquisition norms for 44 thousand English word meanings} In *Behavior Research Methods* 49, 1520–1523.
"AoA"


#' Concrete Norms for 40 thousand English Word lemmas
#'
#' A publicly available dataset with the Test-based age-of-acquisition norms for 44 thousand English word meanings.
#' 
#' 
...
#' 
#' @references Brysbaert, M., Warriner, A.B. & Kuperman, V. (2014). \href{https://link.springer.com/article/10.3758/s13428-013-0403-5}{Concreteness ratings for 40 thousand generally known English word lemmas} In *Behavior Research Methods* 46, 904–911.
"concrete"
...
#' 
#'  
#' @references Rocklage, M. D., & Fazio, R. H. (2015). The Evaluative Lexicon: Adjective use as a means of assessing and distinguishing attitude valence, extremity, and emotionality. In *Journal of Experimental Social Psychology*, 56, 214-227.
"evlex"
...
#' 
#' @references Lynott, D., Connell, L., Brysbaert, M. et al. (2020). \href{https://link.springer.com/article/10.3758/s13428-019-01316-z}{The Lancaster Sensorimotor Norms: multidimensional measures of perceptual and action strength for 40,000 English words.} In *Behavior Research Methods* 52, 1271–1291.
"Lancaster"


#' The Mind Perception Dictionary (MPD)
#'
...
#' 
#' @references Schweitzer, S., & Waytz, A. (2021). \href{https://psycnet.apa.org/fulltext/2020-96445-001.pdf}{Language as a window into mind perception: How mental state language differentiates body and mind, human and nonhuman, and the self from others.} In *Journal of Experimental Psychology: General* 150(8), 1642.
"MPD"


#' The Mental-Physical Verb Norms (MPVN)
#'
...
#' @source \url{https://www.adamwaytz.com/measures-and-materials/the-mind-perception-dictionary}
#' 
#' @references Orr, R. I., & Gilead, M. (2022). \href{https://link.springer.com/article/10.3758/s13428-022-01911-7}{Development and validation of the Mental-Physical Verb Norms (MPVN): A text analysis measure of mental state attribution} In *Behavior Research Methods* 1-21.
"MPVN"
...
#' 
#' @references Mohammad, S. & Turney, P. (2013). \href{https://arxiv.org/abs/1308.6297}{Crowdsourcing a Word-Emotion Association Lexicon.} In *Computational Intelligence*, 29(3), 436–465.
#' 
#' Mohammad, S. & Turney, P. (2010). \href{https://dl.acm.org/citation.cfm?id=1860635}{Emotions Evoked by Common Words and Phrases: Using Mechanical Turk to Create an Emotion Lexicon.} In *Proceedings of the NAACL-HLT 2010 Workshop on Computational Approaches to Analysis and Generation of Emotion in Text*, June 2010, LA, California.
"NRC"
...
#' 
#' @references  Brysbaert, M., Mandera, P., McCormick, S. F., & Keuleers, E. (2019). \href{https://link.springer.com/article/10.3758/s13428-018-1077-9}{Word prevalence norms for 62,000 English lemmas.} In *Behavior Research Methods* 51(2), 467-479.
"Prevalences"
...
#' 
#' @references Choi, V. K., Shrestha, S., Pan, X., & Gelfand, M. J. (2022). \href{https://www.pnas.org/doi/abs/10.1073/pnas.2113891119}{When danger strikes: A linguistic tool for tracking America’s collective response to threats} In *Proceedings of the National Academy of Sciences* 119(4), 19.
"threat"
